...
Laravel running coach that syncs Strava activities and uses Prism/OpenAI to 
generate personalized training plans based on user objectives 
(5K, 10K, half marathon, speed). 
...
* Import last 30 days of running activities
* Daily sync job (fetch new activities)
* Display activity list (distance, pace, date, duration)

## 3. Objective Management
* Create ONE active objective at a time
* Objective types:
    - Run 5K
    - Run 10K
    - Run Half Marathon
    - Run Faster (improve pace)
* Set target date
* Basic validation (reasonable timeframes)

## 4. AI Training Recommendations
* Generate initial training plan on objective creation
* Daily recommendation generation:
    - Training type (easy run, intervals, long run, rest)
    - Distance/duration
    - Target pace
...
* Email content:
    ...
    - Brief reasoning
    - Week summary (activities completed, total km)
